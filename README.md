...
For each of our different fields that we defined we we created an imput or a text area and we made sure to pass in the fields-confuguration object provided by redux-form {... title}. That makes sure that redux-form is 100% in charge of handling all the changes and events emitted from this input.
